...
- Add your data in the `_data` directory
  ...
  - To add this to your project you can use this variable structure:
    ex. 
```
{{ site.data.[site.data.global.lang].header }}
``` 
or for an image: 
```
<img class="image--full-width" src="{{ site.data.global.img-path }}{{ site.data.[site.data.global.lang].header-image }}" alt="{{ site.data.[site.data.global.lang].header-image--alt }}"/>
```
